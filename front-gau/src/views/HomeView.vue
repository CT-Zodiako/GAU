            ...
            <div class="modal-dialog">
              <div class="modal-content" style="background: #efc729;">
                ...
                <div class="modal-body">
                  <form>
                    <div class="mb-3 n">
                      <label for="exampleInputEmail1" class="form-label">Id Clase</label>
                      <input type="text" class="form-control" v-model="id" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="id">
                    </div>
                    <div class="mb-3 n">
                      <label for="exampleInputEmail1" class="form-label">Id Profesor</label>
                      <input type="text" class="form-control" v-model="idProfesor" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="id">
            ...
            <tbody>
              <tr v-for="clases in datosClases" :key="clases.idClase" :src="clases.thumbnailURL" :alt="clases.title">
                ...
                <td class="opciones">
                  ...
                  <div>
                    <button type="button" class="btn btn-warning" @click="editarClase=(clases._id)" style="margin-right: 15px;">
...
export default {
  ...
  methods: {
    ...
    actualizarClase: async function () {
        this.claseServicio = new claseServicio();
        await this.claseServicio.editarClases(this.id, this.idProfesor, this.nombreClase);
    },
